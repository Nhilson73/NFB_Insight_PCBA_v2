#!/usr/bin/env python3
"""Valida Z4 PR12 preservado con footprints físicos cerrados en PR13."""
...
def main():
    ...
    if c["design_policy"]["placement_in_scope"] or c["design_policy"]["routing_in_scope"] or n["placement_in_scope"] or n["routing_in_scope"]: fail("PR13 no debe habilitar placement/routing")
    ...
    if placed: fail(f"PR13 no debe colocar Z4: {placed[:5]}")
    ...
    print(f"OK: Z4 PR12 + footprints PR13 — {len(comps)} refs, placement=0")
