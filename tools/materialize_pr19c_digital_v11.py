...
CANDIDATE_REVISION='v11-act-rpu-pump-local-corridor-active'
...
class RouterV11(v10.RouterV10):
    def _astar(self,net,a,z):
        ...
        if net=='ACT_FAULT_N' and refs=={'R_ACT_FAULT_PU','U_PUMP_DRV'}:
            nodes=[
                (200.75,50.00,pcbnew.F_Cu),(204.75,50.00,pcbnew.F_Cu),(204.75,50.00,pcbnew.B_Cu),
                (204.75,20.50,pcbnew.B_Cu),(213.50,20.50,pcbnew.B_Cu),(213.50,20.50,pcbnew.F_Cu),
                (213.50,17.75,pcbnew.F_Cu),(212.25,17.75,pcbnew.F_Cu),
            ]
    ...
    def route_all(self):
        ...
        r.setdefault('planner',{})['act_fault_rpu_pump_corridor']='F x200.75-204.75@y50; B x204.75 down y20.5 then x213.5; F entry U_PUMP_DRV.18'; return r
