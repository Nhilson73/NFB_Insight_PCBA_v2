...
CANDIDATE_REVISION='v12-drc-local-fixes-via-dedup-active'
...
class RouterV12(v11.RouterV11):
    def _add_via(self,net,clsinfo,ix,iy):
        ...
        for v in self.new_vias:
            if v['net']==net and abs(v['x_mm']-x)<1e-9 and abs(v['y_mm']-y)<1e-9:
                self._mark_via(net,x,y,halo=1); return
    ...
    def _manual_uno_ioref_local(self,eps):
        ...
        before_s,before_v=len(self.new_segments),len(self.new_vias); clsinfo=self.class_info[self.class_by_net['UNO_IOREF_3V3']]; length=0.0
        def seg(layer,a,b):
            nonlocal length
        ...
        seg(pcbnew.B_Cu,v1,(190.5,28.0)); seg(pcbnew.B_Cu,(190.5,28.0),v2); self._add_via('UNO_IOREF_3V3',clsinfo,core.gcoord(v2[0]),core.gcoord(v2[1]))
    ...
    def _astar(self,net,a,z):
        ...
        if net=='ACT_FAULT_N' and refs=={'J_UNOQ','R_ACT_FAULT_PU'}:
            nodes=[(2.50,36.50,pcbnew.B_Cu),(8.00,36.50,pcbnew.B_Cu),(8.00,9.50,pcbnew.B_Cu),(90.50,9.50,pcbnew.B_Cu),
                   (90.50,9.50,pcbnew.F_Cu),(92.25,9.50,pcbnew.F_Cu),(92.25,18.75,pcbnew.F_Cu),(94.00,18.75,pcbnew.F_Cu),
                   (94.00,18.75,pcbnew.B_Cu),(94.00,9.50,pcbnew.B_Cu),(104.50,9.50,pcbnew.B_Cu),(104.50,9.50,pcbnew.F_Cu),
                   (112.50,9.50,pcbnew.F_Cu),(112.50,9.50,pcbnew.B_Cu),(202.50,9.50,pcbnew.B_Cu),(202.50,50.00,pcbnew.B_Cu),
        ...
        if net=='ACT_FAULT_N' and refs=={'R_ACT_FAULT_PU','U_PUMP_DRV'}:
            nodes=[(200.75,50.00,pcbnew.F_Cu),(211.00,50.00,pcbnew.F_Cu),(211.00,50.00,pcbnew.B_Cu),(211.00,28.00,pcbnew.B_Cu),
        ...
        if net=='ACT_FAULT_N' and refs=={'U_CO2_DRV','U_PUMP_DRV'}:
            nodes=[(212.25,17.75,pcbnew.F_Cu),(211.00,17.75,pcbnew.F_Cu),(211.00,17.75,pcbnew.B_Cu),(211.00,22.50,pcbnew.B_Cu),
    ...
    def route_all(self):
        ...
        r.setdefault('planner',{}).update({'via_dedup':'SAME_NET_EXACT_XY','uno_ioref_entry':'via x190.5/y17.5; horizontal F into U_5V.2',
            'i2c_scl_local':'F y18.5 above SDA','act_fault_long':'I2C detour; B direct through HMI; RPU from +X',
            'act_fault_rpu_pump':'B x211 with F bypass y28-25','act_fault_pump_co2':'B/F bypass around PUMP_CURRENT_ADC'})
        return r
