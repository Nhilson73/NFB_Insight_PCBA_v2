#!/usr/bin/env python3
"""Valida interfaces de sensores PR #6 preservadas tras corrección de potencia PR #9."""
...
def main():
    ...
    print("OK: interfaces sensores PR #6 + potencia PR #9")
    print("- pH/ORP/DO acondicionados, TEMP 1-Wire, CO2 MPR I2C 0x28")
    print("- 5V_RAIL/3V3_RAIL locales al shield")
    return 0
