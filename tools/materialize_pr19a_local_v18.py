#!/usr/bin/env python3
"""PR19A v18: aplica micro-rutas declaradas en hardware/pr19a_route_overrides_v18.json."""
...
DATA=json.loads((ROOT/'hardware/pr19a_route_overrides_v18.json').read_text(encoding='utf-8'))
ROUTES=DATA['routes']
...
class RouterPR19AV18(v17.RouterPR19AV17):
    ...
    def _materialize_path(self,net,cls,ci,path,a,b):
        ...
        print('V18_OVERRIDE',r['id'])

impl.RouterPR19A=RouterPR19AV18
