#!/usr/bin/env python3
"""PR19 v6: escapes finos + IOREF long-haul en B.Cu.

PR18 reserva B.Cu para señales secundarias y control/telemetría long-haul.
UNO_IOREF_3V3 es la única CONTROL_SENSITIVE que cruza Z3→Z0; se permite B.Cu
para su troncal después de un escape corto F.Cu desde U_5V/J_UNOQ.
Los feedback/programming locales continúan F.Cu-only.
"""
